...
[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-go/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-go/actions/workflows/validate.yml)

Neovim tree-sitter queries for **go**, part of the
...
- [ ] Changes are scoped to `go` — do not include files for other languages
